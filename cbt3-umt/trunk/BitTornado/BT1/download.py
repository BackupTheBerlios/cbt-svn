...
from BitQueue.__init__ import createPeerID
...
class Download:
    ...
    def download(self, params, filefunc, statusfunc, finfunc, errorfunc, doneflag, cols,
                 ...
                 sem = None, old_dlsize = 0L, old_ulsize = 0L):
        ...
        upmeasure.total = old_ulsize
        downmeasure.total = old_dlsize
        size_done = self.storagewrapper.total_length- \
                    self.storagewrapper.amount_left
        if downmeasure.total < size_done:
            downmeasure.total = size_done
        del size_done
